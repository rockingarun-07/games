...
pipe_image = pygame.image.load('image.png')
bird_image = pygame.transform.scale(bird_image, (bird_width, bird_height))
pipe_image = pygame.transform.scale(pipe_image, (pipe_width, playing_area_height))  # Adjust as needed
...
def draw():
    ...
    def draw_pipe(pipe_x, pipe_space_y):
        # Draw upper pipe
        screen.blit(pipe_image, (pipe_x, 0), (0, 0, pipe_width, pipe_space_y))
        # Draw lower pipe
        screen.blit(pipe_image, (pipe_x, pipe_space_y + pipe_space_height), (0, pipe_space_y + pipe_space_height, pipe_width, playing_area_height - pipe_space_y - pipe_space_height))
